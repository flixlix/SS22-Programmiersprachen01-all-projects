            ...
            t.Fireworks = class {
                ...
                setOptions(t) {
                    for (var [e, i] of Object.entries(t)) {
                        var n = Object.prototype.hasOwnProperty.call(this, e);
                        if ("function" == typeof this[e]) throw new Error("You cannot change the methods of the class!");
                        n && ("object" == typeof this[e] ? Object.assign(this[e], i) : this[e] = i), "sound" === e && Object.assign(this._sound.options, i)
                    }
                }
                setSize() {
                    var {
